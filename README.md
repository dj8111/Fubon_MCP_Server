...
> 
> * **獨立個人開源專案**：本專案為開發者出於技術研究與個人輔助使用所開發之**個人獨立開源專案，非富邦金控或富邦證券官方出品，亦與富邦證券無任何官方隸屬、背書、授權、聘僱或商業合作關係**。專案中提及之「富邦證券」、「Fubon」及相關商標均歸富邦金控或其各自權利人所有。
> * **無任何投資顧問與保證**：本系統所提供之資訊（包括但不限於即時行情、五檔簿、帳務試算、研報整理與交易草稿）僅供技術實驗與投資輔助決策參考，**不構成任何形式之投資建議、招攬、要約或獲利保證**。
> * **請審慎評估自身能力與風險**：金融交易具有市場風險。**使用者在決定使用、部署或串接本專案前，必須充分考量自身之程式能力、資安認知、財務狀況與風險承擔能力**。因軟體瑕疵、網路延遲、API 規範異動、憑證密鑰保管不當或使用者操作失誤所產生之任何直接或間接損失，開發者概不承擔任何法律與財務責任。
...
## 📄 專案授權與完整免責條款 (License & Disclaimer)

本專案採用 **[MIT License](LICENSE)** 開源授權協議。

### ⚠️ 使用條款與風險告知 (Terms of Use)
1. **非官方獨立開發**：本軟體為個人開發者之非商業研究與輔助工具專案，不代表富邦證券之官方立場，亦未獲富邦金控或富邦證券之官方認證或擔保。
2. **無投資招攬與建議**：本專案所有程式碼、輸出結果、AI 對話建議及報價資料，均不代表任何金融商品的買賣建議、獲利保證或投資顧問服務。
3. **能力評估與責任歸屬**：使用者在啟用、部署、修改或使用本專案進行任何真實交易前，**應審慎評估自身之資訊安全防護能力、程式碼除錯能力、金融法規知識與風險承受度**。使用者須對自身帳號、憑證、密碼之安全性及所有交易行為與投資盈虧負完全之法律與財務責任。
4. **無瑕疵擔保**：軟體按「現狀 (AS-IS)」提供，開發者不保證程式完全無錯誤、不中斷，亦不對因使用本系統所導致之任何直接、間接、附隨或衍生性損失承擔賠償責任。
